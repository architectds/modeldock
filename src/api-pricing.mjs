...
const RATES = new Map([
  // OpenCode Go.
  ["deepseek-v4-flash@opencode-go", { input: 0.07, cached: 0.0014, output: 0.14 }],
  ["deepseek-v4-flash-vision-exp@opencode-go", { input: 0.07, cached: 0.0014, output: 0.14 }],
  ...
  ["deepseek-v4-pro@opencode-go", { input: 0.435, cached: 0.003625, output: 0.87 }],
  ...
  ["gpt-5.6-luna@opencode-go", { input: 0.1, cached: 0.01, output: 0.6 }],
  ["grok-4.5@opencode-go", { input: 2, cached: 0.5, output: 6 }],
  ["hy3@opencode-go", { input: 0.14, cached: 0.035, output: 0.58 }],
  ...
  // OpenAI API equivalents for native Codex traffic.
  ["gpt-5.6-sol@openai", { input: 5, cached: 0.5, output: 30 }],
