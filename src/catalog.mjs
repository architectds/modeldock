...
export function baseInstructionsFor(config, { supportsVision = false } = {}) {
  ...
  return [
    ...
    "Before starting a task, check ~/.codex/memories/MEMORY.md for memory groups whose applies_to matches the current working directory, and reuse them when relevant.",
